...
| 📋 Reviews with sections | Each review has metadata (title, date, reviewer) plus any number of sections (e.g. Health & Safety, Programme, Quality), each with notes and photos. Sections can be reordered. |
